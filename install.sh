...
echo ""
echo "2. Available CLI commands:"
echo "   uc start     - Start local server & docker dependencies"
echo "   uc stop      - Stop local server & docker dependencies"
echo "   uc status    - View server status, compression stats & recent logs"
echo "   uc config    - Open interactive configuration TUI"
echo "   uc init      - Configure agent optimization rules in current directory"
echo "   uc env       - Print proxy configuration environment variables"
echo "--------------------------------------------------------"
